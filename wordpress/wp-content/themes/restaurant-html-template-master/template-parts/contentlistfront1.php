...
?>
<li class="col-mg-6 wow dif-impar fadeInLeft especial" data-wow-duration="300ms" data-wow-delay="300ms">
    <div class="content-right nuevos-enlaces">
        <a href="<?php echo get_post_permalink(); ?>" class="title-bold-font nuevos-enlaces"><h3 class="content-link"><?php the_title(); ?></h3></a><hr>
